...
#     for i in range(hp_layers):
#         if i == 0:
#             hp_layer_dimensions[i] = int(100/hp_dropout[i])
#         else:
...
#     model.add(tf.keras.layers.LSTM(100, activation = hp_activation, kernel_initializer=initializer, input_shape = (PREVIOUS_STEPS, 1), return_sequences = True))
#     # Building the encoder layers
#     for i in range(hp_layers):
#         if i == 0:
#             model.add(tf.keras.layers.LSTM(int(hp_layer_dimensions[i]), activation=hp_activation, kernel_initializer=initializer, input_shape = (PREVIOUS_STEPS, 1), return_sequences = True))
#             model.add(tf.keras.layers.Dropout(0.2))
#         elif i == 1:
#             model.add(tf.keras.layers.LSTM(int(hp_layer_dimensions[i]), activation=hp_activation, kernel_initializer=initializer, input_shape = (PREVIOUS_STEPS, 1), return_sequences = False))
#             model.add(tf.keras.layers.Dropout(0.2))
#         else:
...
#     model.add(tf.keras.layers.Dense(100, activation=hp_activation, kernel_initializer=initializer, input_shape = (PREVIOUS_STEPS, 1)))
...
# If the variable is not as suitable for a linear regression model...
    ...
    initializer = tf.keras.initializers.GlorotNormal(seed = 13)
    # encoder
    model.add(tf.keras.layers.LSTM(64, activation = 'swish', kernel_initializer=initializer, input_shape = (PREVIOUS_STEPS, 1), return_sequences = True))
    ...
    model.add(tf.keras.layers.Dense(20, activation = 'swish', kernel_initializer=initializer))
    model.add(tf.keras.layers.Dense(15, activation = 'swish', kernel_initializer=initializer))
    ...
    # model.add(tf.keras.layers.LSTM(25, activation = 'swish', kernel_initializer=initializer, return_sequences = True))
    # model.add(tf.keras.layers.LSTM(30, activation = 'swish', kernel_initializer=initializer, return_sequences = True))
    # model.add(tf.keras.layers.TimeDistributed(tf.keras.layers.Dense(1))) 

    # model.add(tf.keras.layers.Dropout(0.2))
    # model.add(tf.keras.layers.LSTM(30, activation = 'swish', kernel_initializer=initializer, return_sequences = False))
    # model.add(tf.keras.layers.LSTM(60, activation = 'swish', kernel_initializer=initializer, return_sequences = True))
    # model.add(tf.keras.layers.TimeDistributed(tf.keras.layers.Dense(1))) 
    ...
    # model.add(tf.keras.layers.LSTM(32, activation = 'swish', kernel_initializer=initializer, return_sequences = True))
    # model.add(tf.keras.layers.LSTM(16, activation = 'swish', kernel_initializer=initializer, return_sequences = False))
    # model.add(tf.keras.layers.RepeatVector(PREVIOUS_STEPS))
    # model.add(tf.keras.layers.LSTM(16, activation = 'swish', kernel_initializer=initializer, return_sequences = True))
    # model.add(tf.keras.layers.LSTM(32, activation = 'swish', kernel_initializer=initializer, return_sequences = True))
    # model.add(tf.keras.layers.LSTM(64, activation = 'swish', kernel_initializer=initializer, return_sequences = True))
    # model.add(tf.keras.layers.LSTM(128, activation = 'swish', kernel_initializer=initializer, return_sequences = True))
    # model.add(tf.keras.layers.TimeDistributed(tf.keras.layers.Dense(1))) 




    # model.add(tf.keras.layers.LSTM(100, activation = 'swish', kernel_initializer=initializer, input_shape = (PREVIOUS_STEPS, 1), return_sequences = True))
    # model.add(tf.keras.layers.LSTM(85, activation = 'swish', kernel_initializer=initializer, return_sequences = True))
    # model.add(tf.keras.layers.Dropout(0.2))
    # model.add(tf.keras.layers.LSTM(70, activation = 'swish', kernel_initializer=initializer, return_sequences = False))
    # model.add(tf.keras.layers.TimeDistributed(tf.keras.layers.Dense(70)))
    # model.add(tf.keras.layers.Dense(50, activation = 'swish', kernel_initializer=initializer))
    # model.add(tf.keras.layers.Dense(30, activation = 'swish', kernel_initializer=initializer))
    # #decoder
    # model.add(tf.keras.layers.Dense(30, activation = 'swish', kernel_initializer=initializer))
    # model.add(tf.keras.layers.Dense(50, activation = 'swish', kernel_initializer=initializer))
    # model.add(tf.keras.layers.Dense(70, activation = 'swish', kernel_initializer=initializer))
    # model.add(tf.keras.layers.LSTM(70, activation = 'swish', kernel_initializer=initializer, return_sequences = False))
    # model.add(tf.keras.layers.Dropout(0.2))
    # model.add(tf.keras.layers.LSTM(85, activation = 'swish', kernel_initializer=initializer, return_sequences = False))
    # model.add(tf.keras.layers.Dropout(0.2))
    # model.add(tf.keras.layers.LSTM(100, activation = 'swish', kernel_initializer=initializer, return_sequences = True))
    # model.add(tf.keras.layers.TimeDistributed(tf.keras.layers.Dense(1)))
    ...
    history = model.fit(train_X, train_y, epochs = 10, batch_size = 32, validation_data = (test_X, test_y)).history
...
plt.show()
    ...
    # tuner.search(train_X, train_y, epochs = 10, validation_data = (test_X, test_y), callbacks = [early_stop])
